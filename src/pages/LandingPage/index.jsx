...
export default function LandingPagePage() {
  ...
  return (
    <>
      ...
      <div className=" bg-white-A700 shadow-lg">
  ...
  <div className="w-full mx-auto md:p-5 max-w-[801px]">
    <div className="flex justify-between items-center gap-5">
      ...
      <div className="flex justify-end items-center gap-[22px] px-px flex-1">
        
          <Text size="xl" as="p" className="!text-gray-800 text-center">
            <a href="#" className="self-start">Home</a>
          </Text>
        ...
        <div className="flex flex-col gap-[27px]">
          ...
          <div className="flex flex-col my-10 gap-3">
            ...
            <Img
              ...
              alt="clientslogos"
              className="h-[68px] w-full mx-auto max-w-[900px]"
            />
          </div>
  ...
  <div className="flex md:flex-col justify-between items-center w-full gap-5 mx-auto md:p-5 max-w-[772px]">
    <div className="flex flex-col items-start w-[32%] md:w-full gap-[27px]">
      ...
      <div className="flex gap-[11px]">
        <Button color="white_A700" size="s" shape="circle" className="w-[22px]">
